    ...
    <div class="fk ek ey ">
      <div class="pz afo vy">
        <div class="qa">
          ...
          <div data-grid="images" data-target-height="150">
            <img class="bos" data-width="640" data-height="640" data-action="zoom" src="assets/img/unsplash_1.jpg">
          </div>
          <p><strong>It might be time to visit Iceland.</strong> Iceland is so chill, and everything looks cool here. Also, we heard the people are pretty nice. What are you waiting for?</p>
          <button class="cg nz ok"><span class="h bmc"></span></button>
          <button class="cg nz ok"><span class="h bhu"></span></button>
    ...
    <div class="fk ek ey ">
      <div class="pz afo vy">
        <div class="qa">
          ...
          <div data-grid="images" data-target-height="150">
            <img class="bos" data-width="640" data-height="640" data-action="zoom" src="assets/img/instagram_13.jpg">
          </div>
          <p><strong>It might be time to visit Iceland.</strong> Iceland is so chill, and everything looks cool here. Also, we heard the people are pretty nice. What are you waiting for?</p>
          <button class="cg nz ok"><span class="h bmc"></span></button>
          <button class="cg nz ok"><span class="h bhu"></span></button>
    ...
    <div class="fk ek ey ">
      <div class="pz afo vy">
        <div class="qa">
          ...
          <div data-grid="images" data-target-height="150">
            <img class="bos" data-width="640" data-height="640" data-action="zoom" src="assets/img/unsplash_2.jpg">
          </div>
          <p><strong>It might be time to visit Iceland.</strong> Iceland is so chill, and everything looks cool here. Also, we heard the people are pretty nice. What are you waiting for?</p>
          <button class="cg nz ok"><span class="h bmc"></span></button>
          <button class="cg nz ok"><span class="h bhu"></span></button>
...
<div class="cd fade" id="postModal" tabindex="-1" role="dialog" aria-labelledby="bpt" aria-hidden="true">
        <div class="modal-dialog bqt">
            <div class="modal-content">
                <div class="d">
                    <h4 class="modal-title">Create a Post</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <!-- <div class="modal-body axw">
...
<a id="openModal" data-toggle="modal" href="#postModal" style="display:none"></a>

<div class="pfz" data-example-id="" onclick="document.getElementById('openModal').click()">
